...
def start_spelling_test(words):
    """Starts the dictation of the selected word list."""
    if not words:
    ...
    while current_word_index < len(words):
        ...
        clear_screen()
        print(f"Word {current_word_index + 1} of {len(words)}")
        print("\nGet ready to write...")
        ...
        # User controls for the test
        print("\nWhat would you like to do?")
        print("  1. Next Word")
        print("  2. Repeat Word")
        print("  3. End Test and Show List")
        action = input("Choose an option: ")

        if action == '1':
            current_word_index += 1
        elif action == '2':
            # Loop will repeat the current word
            continue
        elif action == '3':
            break
        else:
            print("Invalid option, repeating the word.")
            input("Press Enter to continue...")
    ...
    clear_screen()
    print("=" * 30)
    print("  Test Complete! Review Words")
    print("=" * 30)
